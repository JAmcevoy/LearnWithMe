            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                ...
                <div className="flex items-center justify-center">
                    <button
                        ...
                        className={`bg-blue-500 text-white px-4 py-2 rounded-full shadow-lg hover:bg-blue-600 transition ${submitting || loadingCategories ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
